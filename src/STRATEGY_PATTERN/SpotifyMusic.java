...
public class SpotifyMusic implements StreamingStrategy{
	//Connection
	String client_id = "2c19c4ade83f4c55a03bb7041d0decb0"; // My client id 
	String client_secret = "2b8c0d6dfd6d4ffca6d2c7d08786ebcf"; // My client secret 
	String redirect_uri = ""; // My redirect uri 
	String URL="";

	private String connectUserName="dofouartbi";
	private String connectPassWord="spotify7";
	private Api api;
	...
	public ArrayList<Music> search(String music) {
		// TODO Auto-generated method stub
		final TrackSearchRequest request = api.searchTracks("Tu pac").build();
